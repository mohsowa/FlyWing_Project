                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-8 row justify-content-center align-self-center">
                                        ...
                                        @foreach(\App\Http\Controllers\AirportsController::getAirportsInfo() as $airport)
                                            @if($flight->origin == $airport->code)
                                                <div class="col-sm-12 col-md-5  row">
                                                    <h4 class="col-4 text-primary-p ">
                                                        <strong>{{$flight->origin}}</strong></h4>
                                                    <div class="col text-start">
                                                        <div>{{$airport->name}}</div>
                                                        <div>{{$airport->country}}</div>
                                                        <div class="text-black-50"><i
                                                                    class="fa-solid fa-clock"></i> {{$flight->departure_time}}
                                                        </div>
                                                    </div>
                                                </div>
                                            @endif
                                        ...
                                        @foreach(\App\Http\Controllers\AirportsController::getAirportsInfo() as $airport)
                                            @if($flight->destination == $airport->code)
                                                <div class="col-sm-12 col-md-5 row">
                                                    <h4 class="col-4 text-primary-p">
                                                        <strong>{{$flight->destination}}</strong></h4>
                                                    <div class="col text-start">
                                                        <div>{{$airport->name}}</div>
                                                        <div>{{$airport->country}}</div>
                                                        <div class="text-black-50"><i
                                                                    class="fa-solid fa-clock"></i> {{$flight->arrival_time}}
                                                        </div>
                                                    </div>
                                                </div>
                                            @endif
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-4 row py-3 m-1 bg-main p-1 rounded">
                                        <div class="col">
                                            ...
                                            <form method="post" action="{{route('booking')}}">
                                                ...
                                                <button class="col btn btn-sm btn-blue text-white m-1"
                                                        type="submit">{{Aircraft::where('plane_id' ,$flight->plane_id )->first()->price_econ_class * $passengers}}
                                                    SAR
                                                </button>
                                            </form>
                                        </div>
                                        <div class="col">
                                            ...
                                            <form method="post" action="{{route('booking')}}">
                                                ...
                                                <button class="col btn btn-sm btn-outline-light m-1"
                                                        type="submit"> {{Aircraft::where('plane_id' ,$flight->plane_id )->first()->price_bus_class * $passengers}}
                                                    SAR
                                                </button>
                                            </form>
                                        </div>
                                        <div class="col">
                                            ...
                                            <form method="post" action="{{route('booking')}}">
                                                ...
                                                <button class="col btn btn-sm btn-outline-light m-1"
                                                        type="submit"> {{Aircraft::where('plane_id' ,$flight->plane_id )->first()->price_first_class * $passengers}}
                                                    SAR
                                                </button>
                                            </form>
                                        </div>
                                        ...
                                        <div class="col-sm-12 col-md-12 col-lg-4 row py-3 m-1 bg-main p-1 rounded">
                                            <div class="col">
                                                ...
                                                <form method="post" action="{{route('booking')}}">
                                                    @csrf
                                                    @method('POST')
                                                    <input type="number" value="{{$passengers}}" name="passengers"
                                                           hidden>
                                                    <input type="text" name="flight_id" value="{{$flight->id}}" hidden>
                                                    <input type="text" name="type" value="economy" hidden>
                                                    <button class="col btn btn-sm btn-blue text-white m-1"
